...
class SslCommerzPaymentController extends Controller
{
    ...
    public function payViaAjax(Request $request)
    {
        ...
        # CUSTOMER INFORMATION
        $post_data['cus_name'] = $customer->fname . ' ' . $customer->lname;
        $post_data['cus_email'] = $customer->cus_email;
        $post_data['cus_add1'] = $customer->address;
        $post_data['cus_add2'] = $customer->address2;
        $post_data['cus_city'] = $customer->town;
        $post_data['cus_state'] = $customer->town;
        $post_data['cus_postcode'] = "";
        $post_data['cus_country'] = "Bangladesh";
        $post_data['cus_phone'] = $customer->phone;
        $post_data['cus_fax'] = "";
        $post_data['total_qty'] = $customer->total_qty;
        ...
        $post_data['shipping_method'] = "NO";
        $post_data['product_name'] = "physical product";
        $post_data['product_category'] = "Goods";
        $post_data['product_profile'] = "physical-goods";
