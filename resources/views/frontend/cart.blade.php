            ...
            <form action="{{ route('cart.update') }}" method="POST">
                ...
                <div class="axil-product-cart-wrap">
                                ...
                                <tr>
                                    ...
                                    <td class="product-thumbnail">
                                        <a href="{{ route('product.show', $cart->product->slug) }}">
                                            <img src="{{ asset('storage/'. $cart->product->featured_img) }}"
                                    ...
                                    <td class="product-price" data-title="Price">
                                        {{ $cart->product->selling_price ?? $cart->product->price }}
                                        <span class="currency-symbol">tk</span>
                                    </td>
                                    <td class="product-quantity" data-title="Qty">
                                        <div class="pro-qty">
                                            <input type="number" class="quantity-input" value="{{ $cart->qty }}"
                                                name="qty[{{ $cart->product->id }}]">
                                        </div>
                                    </td>
                                    <td class="product-subtotal" data-title="Subtotal">
                                        {{ ($cart->product->selling_price ?? $cart->product->price) * $cart->qty }}
                                        <span class="currency-symbol">tk</span>
                                    </td>
                                </tr>
                                @php
                    ...
                    <div class="update-btn">
                        ...
                        <button style="display: inline-block; width: fit-content;" class="axil-btn btn-outline">Update
                            Cart</button>
                    </div>
