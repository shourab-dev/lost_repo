                            ...
                            <div class="col-lg-10 order-lg-2">
                                <div class="single-product-thumbnail-wrap zoom-gallery">
                                    <div class="single-product-thumbnail product-large-thumbnail-3 axil-product">
                                        ...
                                        <div class="thumbnail">
                                            <a href="{{ asset('storage/'. $product->featured_img) }}"
                                                class="popup-zoom">
                                        ...
                                        <div class="thumbnail">
                                            <a href="{{ asset('storage/'.$image->title) }}" class="popup-zoom">
                                                <img src="{{ asset('storage/'.$image->title) }}" alt="Product Images">
                                            </a>
                                        </div>
                                        @endforeach
                                        @endif
                    ...
                    <div class="col-lg-5 mb--40">
                        <div class="single-product-content">
                            <div class="inner">
                                ...
                                <span class="price-amount">{{ $product->selling_price ?? null }}tk <strike>{{
                                        $product->price }}tk</strike></span>
                                @else
