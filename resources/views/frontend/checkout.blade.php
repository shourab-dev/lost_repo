                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="axil-checkout-billing">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="last-name" placeholder="Last Name"
                                            value="{{ auth('customer')->user()->last_name ?? null }}">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="address" id="address1" class="mb--15"
                                    placeholder="House number and street name">
                                <input type="text" name="secondary_address" id="address2"
                    ...
                    <div class="col-lg-6">
                        <div class="axil-order-summery order-checkout-summery">
                                ...
                                <table class="table summery-table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="order-product">
                                            <td>{{ $cart->product->title }} <span class="quantity">x{{ $cart->qty
                                                    }}</span></td>
                                            <td>{{ $cart->qty * ($cart->product->selling_price ?? $cart->product->price)
                                                }} tk</td>
                                        </tr>
                                        @php
                            ...
                            <div class="order-payment-method">
                                ...
                                <div class="single-payment">
                                    <div class="input-group justify-content-between align-items-center">
                                        ...
                                        <label for="radio6">SSL Commerze</label>
                            ...
                            <button type="submit" class="axil-btn btn-bg-primary checkout-btn">Process to
                                Checkout</button>
                            <button style="display: none" id="sslczPayBtn" token="if you have any token validation"
