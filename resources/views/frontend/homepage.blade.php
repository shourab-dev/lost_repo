            ...
            <div class="categrie-product-activation slick-layout-wrapper--15 axil-slick-arrow  arrow-top-slide">
                <div class="slick-single-layout">
                    <div class="categrie-product" data-sal="zoom-out" data-sal-delay="200" data-sal-duration="500">
                        <a href="index-1.html#">
                            <img class="img-fluid"
                                src="{{ asset('frontend/assets/images/product/categories/elec-4.png') }}"
                ...
                <div class="slick-single-layout">
                    <div class="categrie-product" data-sal="zoom-out" data-sal-delay="300" data-sal-duration="500">
                        <a href="index-1.html#">
                            <img class="img-fluid"
                                src="{{ asset('frontend/assets/images/product/categories/elec-5.png') }}"
                                alt="product categorie">
                ...
                <div class="slick-single-layout">
                    <div class="categrie-product" data-sal="zoom-out" data-sal-delay="400" data-sal-duration="500">
                        <a href="index-1.html#">
                            <img class="img-fluid"
                                src="{{ asset('frontend/assets/images/product/categories/elec-11.png') }}"
                                alt="product categorie">
                ...
                <div class="slick-single-layout">
                    <div class="categrie-product" data-sal="zoom-out" data-sal-delay="500" data-sal-duration="500">
                        <a href="index-1.html#">
                            <img class="img-fluid"
                                src="{{ asset('frontend/assets/images/product/categories/elec-6.png') }}"
                                alt="product categorie">
                ...
                <div class="slick-single-layout">
                    <div class="categrie-product" data-sal="zoom-out" data-sal-delay="600" data-sal-duration="500">
                        <a href="index-1.html#">
                            <img class="img-fluid"
                                src="{{ asset('frontend/assets/images/product/categories/elec-2.png') }}"
                                alt="product categorie">
                ...
                <div class="slick-single-layout">
                    <div class="categrie-product" data-sal="zoom-out" data-sal-delay="700" data-sal-duration="500">
                        <a href="index-1.html#">
                            <img class="img-fluid"
                                src="{{ asset('frontend/assets/images/product/categories/elec-7.png') }}"
                                alt="product categorie">
                ...
                <div class="slick-single-layout">
                    <div class="categrie-product" data-sal="zoom-out" data-sal-delay="800" data-sal-duration="500">
                        <a href="index-1.html#">
                            <img class="img-fluid"
                                src="{{ asset('frontend/assets/images/product/categories/elec-8.png') }}"
                                alt="product categorie">
                ...
                <div class="slick-single-layout">
                    <div class="categrie-product">
                        <a href="index-1.html#">
                            <img class="img-fluid"
                                src="{{ asset('frontend/assets/images/product/categories/elec-1.png') }}"
                                alt="product categorie">
                ...
                <div class="slick-single-layout">
                    <div class="categrie-product">
                        <a href="index-1.html#">
                            <img class="img-fluid"
                                src="{{ asset('frontend/assets/images/product/categories/elec-9.png') }}"
                                alt="product categorie">
                ...
                <div class="slick-single-layout">
                    <div class="categrie-product">
                        <a href="index-1.html#">
                            <img class="img-fluid"
                                src="{{ asset('frontend/assets/images/product/categories/elec-10.png') }}"
                                alt="product categorie">
