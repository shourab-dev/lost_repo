        ...
        <div class="container">
            <div class="axil-dashboard-warp">
                <div class="axil-dashboard-author">
                    <div class="media">
                        <div class="thumbnail">
                            <img src="{{ auth('customer')->user()->profile_image }}" alt="Hello Annie">
                        </div>
                            ...
                            <nav class="axil-dashboard-nav">
                                <div class="nav nav-tabs" role="tablist">
                                    ...
                                    <a class="nav-item nav-link" data-bs-toggle="tab"
                                        href="my-account.html#nav-downloads" role="tab" aria-selected="false"><i
                                            class="fas fa-file-download"></i>Downloads</a>
                                    <a class="nav-item nav-link" data-bs-toggle="tab" href="my-account.html#nav-address"
                                        ...
                                        <div class="col-lg-6">
                                            <div class="address-info mb--40">
                                                <div
                                                    ...
                                                    <a href="my-account.html#" class="address-edit"><i
